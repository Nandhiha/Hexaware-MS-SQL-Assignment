...
(1,1,'2025-03-15',67500.00),
(2,2,'2025-03-16',18000.00),
(3,3,'2025-03-17',2500.00),
(4,4,'2025-03-18',12300.00),
(5,5,'2025-03-19',9500.00),
(6,6,'2025-03-20',3200.00),
(7,7,'2025-03-20',9800.00),
(8,8,'2025-03-20',28000.00),
(9,9,'2025-03-20',7200.00),
(10,10,'2025-03-20',2200.00);
...
VALUES (11, 1, '2025-03-21', 12500.00);
select * from  Orders;
...
delete from OrderDetails
where OrderID IN (
    select OrderID from Orders where CustomerID = 6
);
